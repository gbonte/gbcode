...
```{echo=TRUE}
  ...
  Yhat.rank<-c(Yhat.rank,pred("rf",Xtr[,subs.rank[1:ns]],
  factor(Ytr),Xts[,subs.rank[1:ns]],class=TRUE)$prob[,"1"])     
  Yhat.mrmr<-c(Yhat.mrmr,pred("rf",Xtr[,subs.mrmr[1:ns]],factor(Ytr),
  Xts[,subs.mrmr[1:ns]],class=TRUE)$prob[,"1"])
  Yhat.mimr<-c(Yhat.mimr,pred("rf",Xtr[,subs.mimr[1:ns]],factor(Ytr),
  Xts[,subs.mimr[1:ns]],class=TRUE)$prob[,"1"])                 
  Yhat.rf<-c(Yhat.rf,pred("rf",Xtr[,subs.rf[1:ns]],factor(Ytr),
  Xts[,subs.rf[1:ns]],class=TRUE)$prob[,"1"]) 
  Yhat.rf2<-c(Yhat.rf2,pred("rf",Xtr[,subs.rf2[1:ns]],factor(Ytr),
  Xts[,subs.rf2[1:ns]],class=TRUE)$prob[,"1"])   
  }
  ...
  cat("\n f=",author ,"N=",N,"n=",n,
  "cv=",cv,"AUC.rank=",mean(auc.rank),"AUC.mrmr=",
  mean(auc.mrmr),"AUC.mimr=",
  mean(auc.mimr), "AUC.rf=",mean(auc.rf),
  "AUC.rf2=",mean(auc.rf2),"\n")
  
  
  } ## for cv
  
  
  AUC.rank<-c(AUC.rank,auc.rank)
  AUC.mrmr<-c(AUC.mrmr,auc.mrmr)
  AUC.mimr<-c(AUC.mimr,auc.mimr)
  AUC.rf<-c(AUC.rf,auc.rf)
  AUC.rf2<-c(AUC.rf2,auc.rf2)
  
  cat("\n AAUC.rank=",mean(AUC.rank),"AAUC.mrmr=",  mean(AUC.mrmr),"AAUC.mimr=",  mean(AUC.mimr),
  "AAUC.rf=",mean(AUC.rf),   "AAUC.rf2=",mean(AUC.rf2), "\n")
