  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "Bivariatemixture",
              fluidRow(
                box(width=3,title = "Data",plotOutput("biPlotD")),
              ...
              fluidRow(
                box(width=4,title = "p(green|x)",collapsible = TRUE,plotOutput("biPlotC1")),
                box(width=4,title = "p(red|x)",collapsible = TRUE,plotOutput("biPlotC2")))
