...
cat("TF=",as.numeric(d[[1]]), as.numeric(g11.1),"\n") 

g12.1=gp(a1.2)*w21.2*gp(a2.1)*x ## dyhat/dw12.1
cat("TF=",as.numeric(d[[2]]), as.numeric(g12.1),"\n") 

g11.2=gp(a1.2)*z1  ## dyhat/dw11.2
cat("TF=",as.numeric(d[[3]]), as.numeric(g11.2),"\n")

g21.2=gp(a1.2)*z2 ## dyhat/dw21.2
cat("TF=",as.numeric(d[[4]]), as.numeric(g21.2),"\n")