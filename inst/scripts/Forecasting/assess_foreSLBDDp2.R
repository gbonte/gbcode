...
files=c("mexpimpcnus","gdpsimple6c8018","FREDMDApril19","PElectricity1344","Stockindexes99world",
...
for ( f in 1:length(files)){
  ...
  season=TRUE
  execute=TRUE
  methods=c("uni","VAR","VARs","uni","dfm","dfml","uni","multifs","multifs2","multipls")
  ...
  for (r in 1:Nsets){
    ...
    FF<-foreach( Ntr=NtrCV )%dopar%{
      ...
      #  methods=c("uni","VAR","VARs","dfm","dfm","dfml","uni","multifs","multifs2","multipls")
      ...
      Xhat5=MmultiplestepAhead(Xtr,n,H,multi=methods[5],
                               dfmlmodels=c("multifs"))
      cat(".")
      Xhat6=MmultiplestepAhead(Xtr,n,H,multi=methods[6],cdfml=2, Lcv=10,
                               dfmlmodels=c("multifs","stat_comb"))
      cat(".")
      Xhat7=MmultiplestepAhead(Xtr,n,H,multi=methods[7],uni="mimolin")
      cat(".")
      ...
      Xhat10=MmultiplestepAhead(Xtr,n,H,multi=methods[10],
                                minLambda=0.1,maxLambda=100,stepLambda=0.5,
                                QRdec=FALSE)
      cat(".")
