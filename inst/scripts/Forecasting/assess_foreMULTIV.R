...
methods=c("uni","multiridge2","multiteridge2","multiteridgeMC",
          "uni","uni","VARs","directridge",
          "uni","uni", "uni","uni")
...
##  FF<-foreach( Ntr=NtrCV )%dopar%{
      ...
      cat(".")
      Xhat2=MmultiplestepAhead(Xtr,n,H,multi=methods[2],mod="py.piperf_regr")
      
      cat(".")
      Xhat3=MmultiplestepAhead(Xtr,n,H,multi=methods[3],mod="py.gb_regr")
     
      cat(".")
     
      Xhat4=MmultiplestepAhead(Xtr,n,H,multi=methods[4],mod="py.ab_regr")
     
      cat(".")
      
      Xhat5=MmultiplestepAhead(Xtr,n,H,multi=methods[5],mod="py.rf_regr")
      
      cat(".")
     
      Xhat6=MmultiplestepAhead(Xtr,n,H,multi=methods[6],mod="py.lasso_regr")
      ...
      cat(".")
      Xhat9=MmultiplestepAhead(Xtr,n,H,multi=methods[9],uni="stat_comb")
      cat(".")
      Xhat10=MmultiplestepAhead(Xtr,n,H,multi=methods[10],uni="stat_naive")
      cat(".")
      Xhat11=MmultiplestepAhead(Xtr,n,H,multi=methods[11],uni="lindirect")
      cat(".")
