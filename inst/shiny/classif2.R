  ...
  dashboardBody(
    tabItems(
              ...
              fluidRow(
                ...
                box(width=3,
                    sliderInput("mean12",withMathJax(sprintf('$$\\mu_{12}:$$')),min = -BOUND1, max = BOUND1 ,
                                value = -2,step=0.1)),
                box(width=3,
                    sliderInput("variance11",withMathJax(sprintf('$$\\sigma^2_1:$$')),
              ...
              fluidRow(
                ...
                box(width=3,
                    sliderInput("mean22",withMathJax(sprintf('$$\\mu_{22}:$$')),min = -BOUND1, max = BOUND1 ,
                                value = 2,step=0.1)),
                box(width=3,
                    sliderInput("variance22",withMathJax(sprintf('$$\\sigma^2_2:$$')),min = 0.5,max = 1, 
                                value = 0.75,step=0.05)),
                box(width=3,
                    sliderInput("p11",withMathJax(sprintf('$$P_1:$$')),min = 0.01, max = 0.99 ,
                                value = 0.5,step=0.05))),
      ...
      tabItem(tabName = "Bimodal",
              fluidRow(
                box(width=2,
                    sliderInput("bmean11a",withMathJax(sprintf('$$\\mu^a_{11}:$$')),min = -BOUND1, max = BOUND1 ,
                                value = -2,step=0.1)),
                box(width=2,
                    sliderInput("bmean12a",withMathJax(sprintf('$$\\mu^a_{12}:$$')),min = -BOUND1, max = BOUND1 ,
                                value = -2,step=0.1)),
                box(width=2,
                    sliderInput("bmean11b",withMathJax(sprintf('$$\\mu^b_{11}:$$')),min = -BOUND1, max = BOUND1 ,
                                value = 2,step=0.1)),
                box(width=2,
                    sliderInput("bmean12b",withMathJax(sprintf('$$\\mu^b_{12}:$$')),min = -BOUND1, max = BOUND1 ,
                                value = 2,step=0.1)),
                box(width=2,
                    sliderInput("bvariance11",withMathJax(sprintf('$$\\sigma^2_1:$$')),min = 0.5,max = 1, value = 0.75,
                                step=0.05))
              ),
              
              fluidRow(
                box(width=2,
                    sliderInput("bmean21",withMathJax(sprintf('$$\\mu_{21}:$$')),min = -BOUND1, max = BOUND1 ,
                                value = 0,step=0.1)),
                box(width=2,
                    sliderInput("bmean22",withMathJax(sprintf('$$\\mu_{22}:$$')),min = -BOUND1, max = BOUND1 ,
                                value = 0,step=0.1)),
                
                box(width=2,
                    sliderInput("bvariance22",withMathJax(sprintf('$$\\sigma^2_2:$$')),min = 0.5,max = 1, 
                                value = 0.75,step=0.05)),
                box(width=2,
                    sliderInput("bp11",withMathJax(sprintf('$$P_1:$$')),min = 0.01, max = 0.99 ,
                                value = 0.5,step=0.05))),
              fluidRow(box(width=6,title = "Distributions p(x|y)",collapsible = TRUE,
