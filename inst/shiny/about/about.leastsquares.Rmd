...
the least squares estimation vector $\hat{\beta}^{LS}_0,\hat{\beta}^{LS}_1$ corresponding to the global minimum.
Red dot denotes the estimation vector $\hat{\beta}_0,\hat{\beta}_1$ 
